 ...
 */
function createLanguageModel(modelName) {
    var _this = this;
    return {
        complete: function (prompt_1) {
            var args_1 = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args_1[_i - 1] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([prompt_1], args_1, true), void 0, function (prompt, options) {
                var temperature, systemInstructions;
                if (options === void 0) { options = {}; }
                return __generator(this, function (_a) {
                    temperature = options.temperature || 0;
                    systemInstructions = "You are a code analyzer specialized in understanding software patterns and features.\nYour task is to analyze repository content and provide thoughtful, structured responses.\nAlways respond with clean JSON when asked for specific formats.";
                    if (temperature > 0.3) {
                        return [2 /*return*/, (0, models_js_1.reason)(prompt, systemInstructions)];
                    }
                    else {
                        return [2 /*return*/, (0, models_js_1.quick)(prompt, systemInstructions)];
                    }
                    return [2 /*return*/];
                });
            });
